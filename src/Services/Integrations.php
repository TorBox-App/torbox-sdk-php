...
No authorization needed. This is a whitelabel OAuth solution.
     */
    public function authenticateOauth(string $apiVersion, string $provider): mixed
    {
        $data = $this->sendRequest('get', "/{$apiVersion}/api/integration/oauth/{$provider}", []);
...
Requires an API key using the Authorization Bearer Header.
     */
    public function queueGoogleDrive(string $apiVersion, ?mixed $input = null): mixed
    {
        $data = $this->sendRequest('post', "/{$apiVersion}/api/integration/googledrive", [
...
Requires an API key using the Authorization Bearer Header.
     */
    public function queuePixeldrain(string $apiVersion, ?mixed $input = null): mixed
    {
        $data = $this->sendRequest('post', "/{$apiVersion}/api/integration/pixeldrain", [
            'json' => Serializer::serialize($input),
        ]);
...
Requires an API key using the Authorization Bearer Header.
     */
    public function queueOnedrive(string $apiVersion, ?mixed $input = null): mixed
    {
        $data = $this->sendRequest('post', "/{$apiVersion}/api/integration/onedrive", [
            'json' => Serializer::serialize($input),
        ]);
...
Requires an API key using the Authorization Bearer Header.
     */
    public function queueGofile(string $apiVersion, ?mixed $input = null): mixed
    {
        $data = $this->sendRequest('post', "/{$apiVersion}/api/integration/gofile", [
            'json' => Serializer::serialize($input),
        ]);
...
Requires an API key using the Authorization Bearer Header.
     */
    public function queue1fichier(string $apiVersion, ?mixed $input = null): mixed
    {
        $data = $this->sendRequest('post', "/{$apiVersion}/api/integration/1fichier", [
            'json' => Serializer::serialize($input),
        ]);
...
Requires an API key using the Authorization Bearer Header.
     */
    public function getAllJobs(string $apiVersion): Models\GetAllJobsOkResponse
    {
        $data = $this->sendRequest('get', "/{$apiVersion}/api/integration/jobs", []);

        return Serializer::deserialize($data, Models\GetAllJobsOkResponse::class);
    }
...
Requires an API key using the Authorization Bearer Header.
     */
    public function getSpecificJob(string $apiVersion, string $jobId): mixed
    {
        $data = $this->sendRequest('get', "/{$apiVersion}/api/integration/job/{$jobId}", []);
...
Requires an API key using the Authorization Bearer Header.
     */
    public function cancelSpecificJob(string $apiVersion, string $jobId): mixed
    {
        $data = $this->sendRequest('delete', "/{$apiVersion}/api/integration/job/{$jobId}", []);
...
Requires an API key using the Authorization Bearer Header.
     */
    public function getAllJobsByHash(string $apiVersion, string $hash): Models\GetAllJobsByHashOkResponse
    {
        $data = $this->sendRequest('get', "/{$apiVersion}/api/integration/jobs/{$hash}", []);

        return Serializer::deserialize($data, Models\GetAllJobsByHashOkResponse::class);
    }
}
